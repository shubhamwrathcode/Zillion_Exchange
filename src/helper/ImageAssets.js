...
export const wallet_ic = require('../../assets/images/wallet.png');
...
export const camera_ic_big = require('../../assets/images/camera_ic_big.png');
...
export const bitcoinIcon = require('../../assets/images/Bitcoin.png');
export const rupeeIcon = require('../../assets/images/rupee.png');
export const bnbIcon = require('../../assets/images/bnb.png');
export const checkIcon = require('../../assets/images/check_selected.png');
export const upGraphIcon = require('../../assets/images/up_graph_ic.png');
...
export const convertIcon = require('../../assets/images/convert_ic.png');
...
export const copyIcon = require('../../assets/images/copy_ic.png');
...
export const arrowRightIcon = require('../../assets/images/arrow_right.png');
export const inviteIcon = require('../../assets/images/invite_earn_ic.png');
export const giftIc = require('../../assets/images/gift_ic.png');
export const editIcon = require('../../assets/images/edit_ic.png');
export const editTextIcon = require('../../assets/images/editTextIcon.png');
export const phoneIcon = require('../../assets/images/phoneIcon.png');
export const nomineeIcon = require('../../assets/images/nomineeIcon.png');
...
export const graphIcon = require('../../assets/images/graph_candle_ic.png');
...
export const Frame1 = require('../../assets/images/Frame1.png');
export const history = require('../../assets/images/conversion_history.png');
export const convertTo = require('../../assets/images/convertTo.png');
export const equals = require('../../assets/images/equals.png');
export const add_more = require('../../assets/images/add_more.png');
export const closeIcon = require('../../assets/images/close.png');
export const convertBg = require('../../assets/images/convert_bg.png');
export const checkIc = require('../../assets/images/check.png');
export const buyCrypto = require('../../assets/images/buy_crypto.png');
export const tradeBtnImg = require('../../assets/images/tradeBtnImg.png');
export const languageIcon = require('../../assets/images/language.png');
export const RECYCLE = require('../../assets/images/recycle.png');
export const LINE_IMG = require('../../assets/images/LineImg.png');
export const SUCCESS_IMG = require('../../assets/images/sucessImg.png');
export const p2p_Icon = require('../../assets/images/p2pIcon.png');
...
export const notifyIcon = require('../../assets/images/notifyicon.png');
export const filterIcon = require('../../assets/images/filterIcon.png');
export const customUserImg = require('../../assets/images/customUserImg.png');
...
export const RADIO_ON = require('../../assets/images/radioOn.png');
export const RADIO_OFF = require('../../assets/images/radioOff.png');
export const stroke = require('../../assets/images/stroke.png');
export const ruppeIcon = require('../../assets/images/ruppeIcon.png');
export const INFO = require('../../assets/images/info.png');
export const YELLOW_DONE = require('../../assets/images/yellowDone.png');
export const CHAT_IMG = require('../../assets/images/chatImg.png');
...
export const spotDarkIcon = require('../../assets/images/spotDarkIcon.png');
...
export const homeImage4 = require('../../assets/images/homeImage4.png');
export const NEW_STAR = require('../../assets/images/newStar.png');
export const KYC_THEME = require('../../assets/images/KYCTheme.png');
export const KYC_IDENTITY = require('../../assets/images/kycIdentity.png');
export const KYC_RATIO = require('../../assets/images/kycRatio.png');
export const IDENTITY_CARD = require('../../assets/images/identityCard.png');
...
export const spotTabIcon = require('../../assets/images/spotTabIcon.png');
export const gainerIcon = require('../../assets/images/gainerIcon.png');
export const usdtIcon = require('../../assets/images/usdtIcon.png');
export const trxIcon = require('../../assets/images/trxIcon.png');
export const coinActive = require('../../assets/images/coinActive.png');
export const coinInActive = require('../../assets/images/coinInActive.png');
export const memeXtext = require('../../assets/images/memeXtext.png');
export const listingIcon = require('../../assets/images/listingIcon.png');
export const discoverIcon = require('../../assets/images/discoverIcon.png');
export const meme1 = require('../../assets/images/meme1.png');
export const meme2 = require('../../assets/images/meme2.png');
export const meme3 = require('../../assets/images/meme3.png');
export const newDepositIcon = require('../../assets/images/newDepositIcon.png');
export const newDepositDarkIcon = require('../../assets/images/newDepositDarkIcon.png');
export const newWidthrawIcon = require('../../assets/images/newWidthrawIcon.png');
export const newWidthrawDarkIcon = require('../../assets/images/newWidthrawDarkIcon.png');
export const transferIcon = require('../../assets/images/transferIcon.png');
export const futureTransferIcon = require('../../assets/images/futureTransferIcon.png');
export const transferDarkIcon = require('../../assets/images/transferDarkIcon.png');
...
export const newContactICon = require('../../assets/images/newContactIcon.png');
export const spotActiveIcon = require('../../assets/images/spotActiveIcon.png');
export const printIcon = require('../../assets/images/printIcon.png');
export const moreOption = require('../../assets/images/moreOption.png');
export const sideIcon = require('../../assets/images/sideIcon.png');
export const symbol = require('../../assets/images/symbol.png');
export const fiatDespositIcon = require('../../assets/images/fiatDespositIcon.png');
export const fiatDespositDarkIcon = require('../../assets/images/fiatDespositDarkIcon.png');
export const disclaimerIcon = require('../../assets/images/disclaimerIcon.png');
export const qrCodeIcon = require('../../assets/images/qrCodeIcon.png');
export const satIcon = require('../../assets/images/satIcon.png');
export const buySellIcon = require('../../assets/images/buySellIcon.png');
export const buySellDarkIcon = require('../../assets/images/buySellDarkIcon.png');
export const Refresh = require('../../assets/images/refresh.png');
export const StarFillIcon = require('../../assets/images/StarFillIcon.png');
export const moonIcon = require('../../assets/images/moonIcon.png');
export const Send_Img = require('../../assets/images/send.png');
