            ...
            <View style={{ marginTop: 40 }}>
              ...
              >
                <View style={{ flexDirection: "row", alignItems: "center" }}>
                  <FastImage
                   source={theme !== "Dark" ? newWidthrawIcon : newDepositDarkIcon}
                    resizeMode="contain"
              ...
              >
                <View style={{ flexDirection: "row", alignItems: "center" }}>
                  ...
                  <View style={{ marginLeft: 10 }}>
                    ...
                    <AppText style={{color: theme !== "Dark" ?"#454444" :colors.offWhite }}>Withdraw your funds via bank Transfer </AppText>
                  </View>
                </View>
                <FastImage
                  source={back_ic}
